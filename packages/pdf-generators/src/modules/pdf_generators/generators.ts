...
${importSection ? `\n${importSection}\n` : ''}
export const pdfGeneratorTemplateEntries: Array<{ moduleId: string; templates: TemplateEntry[] }> = [
...
const pdfGeneratorsPlugin: GeneratorPlugin = {
  ...
  configExpr: (importName: string, moduleId: string) =>
    `{ moduleId: '${moduleId}', templates: ((${importName}.default ?? ${importName}.templates ?? []) as TemplateEntry[]) }`,
